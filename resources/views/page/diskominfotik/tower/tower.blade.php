        ...
        <section class="card">
          <header class="card-header">
            ...
            <span class="tools pull-right">
              <a href="/tower/create" class="btn btn-sm btn-outline-success mb-2"><i class="fa fa-plus"
          ...
          <div class="card-body">
            <div class="adv-table">
              <form method="get" action="{{ url('tower/cari') }}" data-toggle="validator" enctype="multipart/form-data"
                novalidate>
                @csrf
