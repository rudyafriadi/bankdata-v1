                  ...
                  <tr class="gradeU">
                    ...
                    <td>
                      <a data-toggle="modal" data-target="#update" data-id="{{$data->id}}"
                        data-program="{{$data->n_program}}" data-status="{{$data->status}}"
                        class="btn btn-warning mb-2 btn-sm"><i class="fa fa-edit"></i></a>

                      <a href="#" type="button" class="btn btn-sm mb-2 btn-danger delete" program-id="{{$data->id}}"
                        program-nama="{{$data->n_program}}"><i class="fa fa-trash-o"></i></a>
                    </td>
                  </tr>
                  @endforeach
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form role="form" method="POST" action="{{ url('program/simpan') }}" data-toggle="validator"
          enctype="multipart/form-data" role="form">
          @csrf
          <div class="form-group">
            <label for="exampleInputEmail1">Nama</label>
            <input type="text" name="n_program" class="form-control" id="exampleInputEmail3" placeholder="Nama Program">
          </div>
          <div class="form-group">
  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form role="form" method="POST" action="{{ url('program/update/id') }}" data-toggle="validator"
          enctype="multipart/form-data" role="form">
          @method('patch')
          @csrf
          <div class="form-group">
            ...
            <input type="text" name="n_program" class="form-control" id="program" placeholder="Nama Program">
          </div>
...
<script>
  $('.delete').click(function(){
    ...
    var program_nama = $(this).attr('program-nama');
    swal({
      title: "Yakin ?",
      text: "Mau di Hapus data dengan nama "+program_nama+" ??",
      icon: "warning",
      buttons: true,
      dangerMode: true,
      })
      .then((willDelete) => {
      if (willDelete) {
        window.location = "/program/delete/" + program_id;
