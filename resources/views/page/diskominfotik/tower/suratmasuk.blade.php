      ...
      <div class="modal-body">
        ...
        <form role="form" method="POST" action="{{ url('dokumen/simpan') }}" data-toggle="validator"
          ...
          <div class="form-group">
            ...
            <input type="hidden" value="2" name="kat_doc" class="form-control" id="exampleInputEmail3">
            <input type="hidden" value="1" name="j_doc" class="form-control" id="exampleInputEmail3">
          </div>
          <div class="form-group">
