  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form role="form" method="POST" action="{{ url('barang/simpan') }}" data-toggle="validator"
          enctype="multipart/form-data" role="form">
          @csrf
          <div class="form-group">
            <label for="exampleInputEmail1">Nama Barang</label>
            <input type="text" name="n_barang" class="form-control" id="exampleInputEmail3" placeholder="Nama Barang">
          </div>
          <div class="form-group">
