  ...
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form role="form" method="POST" action="{{ url('kecamatan/simpan') }}" data-toggle="validator"
          enctype="multipart/form-data" role="form">
          @csrf
          <div class="form-group">
            <label for="exampleInputEmail1">Kecamatan</label>
            <input type="text" name="n_kec" class="form-control" id="exampleInputEmail3" placeholder="Nama Kecamatan">
          </div>
...
<script>
  $('.delete').click(function(){
    ...
    swal({
      ...
      .then((willDelete) => {
      if (willDelete) {
        window.location = "/provider/delete/" + provider_id;
